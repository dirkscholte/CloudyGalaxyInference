...
line_labels = ['H_BETA', 'OIII_4959', 'OIII_5007', 'NII_6548', 'H_ALPHA', 'NII_6584', 'SII_6717', 'SII_6731']
...
def simulation(theta, redshift='random'):
    ...
    rest_wavelength = np.array([4861.,4959.,5007.,6548.,6563.,6584.,6717.,6731.])
...
if True:
    ...
    for epoch in save_epochs:
        ...
        torch.save(posterior.net, './sbi_inference_SDSS_train_1M_Hb_OIII_OIII_NII_Ha_NII_SII_SII_epoch_{}'.format(epoch))
