...
posterior.net = torch.load('sbi_inference_MUSE_train_1M_Hb_OIII_OIII_NII_Ha_NII_epoch_35')
...
for j in range(len(data_df)):
    ...
    if j % 100 == 0.0:
        np.save('sbi_fits_MUSE_train_1M_Hb_OIII_OIII_NII_Ha_NII_epoch_35.npy', parameters)
